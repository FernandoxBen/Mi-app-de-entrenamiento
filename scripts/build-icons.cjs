...
(async()=>{
  ...
  await sharp(path.join(root,'logo.svg')).resize(410,410).extend({top:51,bottom:51,left:51,right:51,background:'#101b16'}).png().toFile(path.join(root,'icon-maskable.png'));
